...
import com.example.msscolarite.dao.EtablissementRepository;
...
@EnableFeignClients // to use feign client we should use it
public class MsScolariteApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        etudiantRepository.save(new Etudiant(null,"ali", Date.valueOf("1995-11-22"),"4siw",null,e1,2L,null));
        etudiantRepository.save(new Etudiant(null,"karim", Date.valueOf("1996-11-01"),"MasterSiC",null,e2,1L,null));
        etudiantRepository.save(new Etudiant(null,"fouad", Date.valueOf("2000-02-15"),"MasterSiE",null,e2,1L,null));
    }
}
